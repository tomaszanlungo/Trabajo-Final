      ...
      const plot = Plot.plot({
        ...
        marks: [
          ...
          Plot.barY(dataByHour, 
            ...
            Plot.groupX({y: "sum"}, {x: "hour", y: "hoursPlayed", fill: "#FF84BD"})
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Ejecuta la función inicialmente para comprobar la visibilidad al cargar la página
  checkVisibility();

  // Agrega un event listener al evento scroll para comprobar la visibilidad mientras se desplaza la página
